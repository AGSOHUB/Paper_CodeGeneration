 ...
 * manipulating the GPIO mode register (MODER). It calculates the pin position
 * from the provided pin mask and sets the mode accordingly.
 *
 ...
 * and reliable setting or clearing of the pin state.
 *
 ...
 * @param value The value to write to the pin (0 to clear, non-zero to set).
 */
 ...
 * GPIO Output Data Register (ODR). It calculates the pin position from the
 * provided pin mask and uses a bitwise XOR operation to toggle the pin state.
 *
 * @param gpio_port_base The base address of the GPIO port (e.g., 0x40020000 for GPIOA).
