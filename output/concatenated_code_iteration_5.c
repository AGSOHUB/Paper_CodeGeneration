 ...
 * 
 * This function reads the Input Data Register (IDR) of the GPIO port to determine
 * the current state of a specific pin. It calculates the pin position using a loop
 * to ensure accurate bit manipulation.
 * 
 ...
 * 
 * This function sets the mode of a specific GPIO pin by directly manipulating
 * the GPIO mode register (MODER) of the STM32F407 microcontroller. It calculates
 * the pin position from the provided pin mask and sets the mode accordingly.
 * 
