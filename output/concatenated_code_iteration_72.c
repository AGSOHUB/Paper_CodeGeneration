 ...
 * to set or clear a specific pin. It calculates the bit position of the pin using a loop
 * and performs atomic operations to ensure reliable pin state changes.
 *
 * @param gpio_port_base The base address of the GPIO port (e.g., 0x40020000 for GPIOA).
