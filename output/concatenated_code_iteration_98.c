 ...
 * 
 * This function creates a delay for the specified duration in milliseconds.
 * It uses a busy-wait loop to achieve the delay, assuming a system clock of 16 MHz
 * and SysTick configured to generate an interrupt every 1 ms.
 * 
