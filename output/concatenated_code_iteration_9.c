 ...
 *
 * This function writes a high or low value to a GPIO pin specified by the port base address and pin mask.
 * It calculates the pin position and directly manipulates the output data register (ODR) to set the pin state.
 * 
 * @param gpio_port_base The base address of the GPIO port (e.g., 0x40020000 for GPIOA).
