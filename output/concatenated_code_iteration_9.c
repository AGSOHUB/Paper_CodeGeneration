 ...
 * 
 * This function writes to the output data register (ODR) of the specified GPIO port
 * to set or reset the state of the specified pin. It calculates the pin position
 * using a loop to find the first set bit in the pin mask.
 * 
 * @param gpio_port_base The base address of the GPIO port (e.g., 0x40020000 for GPIOA).
