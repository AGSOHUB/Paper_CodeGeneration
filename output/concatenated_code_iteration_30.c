 ...
 * to ensure atomic and reliable operations.
 *
 ...
 *
 * This function sets or clears a GPIO pin by directly manipulating the
 * Output Data Register (ODR) of the specified GPIO port. It uses bitwise
 * operations to ensure atomic and reliable operations.
 *
 * @param gpio_port_base The base address of the GPIO port (e.g., 0x40020000 for GPIOA).
